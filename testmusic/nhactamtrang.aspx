<%@ Page Title="" Language="C#" MasterPageFile="~/pagemaster.Master" AutoEventWireup="true" CodeBehind="nhactamtrang.aspx.cs" Inherits="testmusic.WebForm21" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="css/nhactamtrang.css" rel="stylesheet" />
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Content2" runat="server">
     <h3 style="margin-left: 5px;" > <a  class="tit" href="index.aspx" style="color:black">Trang chủ</a> > Hôm Nay Nghe Gì </h3>
    <hr  style="width:85%"/>
    <div class="chiacot">
    <div class="warp">
        <div class="slider">
